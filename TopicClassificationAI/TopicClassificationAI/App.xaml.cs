...
namespace TopicClassificationAI
{
	...
	sealed partial class App : Application
	{
		...
		{
			if (e.Exception.GetType() == typeof(TopicValidationException))
			{
				e.Handled = true;

				var dialog = new Windows.UI.Popups.MessageDialog(e.Message, "Oops");

				dialog.Commands.Add(new Windows.UI.Popups.UICommand("Okay") { Id = 0 });
